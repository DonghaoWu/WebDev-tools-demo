...
1. 运行顺序：
    ...
    - 个人想法，异步函数是有副作用的，在这里我想 thunkMiddleware 的作用就是可以等这个异步函数完全执行之后再跳出来。`(,4月18日记,这个想法已经被证实，详细可以参考`  [Part6 - Dispatch-Thunk](https://github.com/DonghaoWu/MERN-Doc-V1/blob/master/README-Folder/Front-end(part6-9)/9-Redux-Connection.md) )
